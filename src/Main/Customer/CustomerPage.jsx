...
const initialCustomers = [
  { id: 1, name: 'PT Sinar Mas Agro', contact: 'Budi Santoso', phone: '021-5551234', email: 'budi@sinarmas.co.id', address: 'Jl. Sudirman No. 123, Jakarta', type: 'Corporate' },
  { id: 2, name: 'CV Maju Jaya', contact: 'Dewi Lestari', phone: '022-4445678', email: 'dewi@majujaya.com', address: 'Jl. Asia Afrika No. 45, Bandung', type: 'Corporate' },
  { id: 3, name: 'PT Krakatau Steel', contact: 'Agus Wijaya', phone: '0254-396789', email: 'agus@krakatau.co.id', address: 'Jl. Industri No. 1, Cilegon', type: 'Corporate' },
  { id: 4, name: 'Toko Elektrik Jaya', contact: 'Hendra', phone: '031-8889999', email: 'hendra@elektrikjaya.com', address: 'Jl. Raya Darmo No. 78, Surabaya', type: 'Retail' },
  { id: 5, name: 'PT Pertamina EP', contact: 'Siti Rahayu', phone: '021-3815111', email: 'siti@pertamina.com', address: 'Jl. Medan Merdeka Timur, Jakarta', type: 'Corporate' },
];
        ...
        <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 px-4 sm:px-6 lg:px-8 py-6">
          <div className="max-w-[1400px] mx-auto flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
              ...
              <p className="text-slate-500 text-sm mt-1">{filteredCustomers.length} of {customers.length} customers</p>
            </div>
