        ...
        <div className="flex w-full min-h-screen bg-slate-50 dark:bg-slate-950 font-sans text-slate-800 dark:text-slate-100 transition-colors duration-300">
          ...
          <div className="flex-1 lg:ml-0 overflow-hidden">
            <Routes>
              ...
              <Route path="/projects/:projectId" element={<ProjectDetail setSidebarOpen={setSidebarOpen} />} />
              <Route path="/projects/:projectId/panels/:panelId/edit" element={<ProjectEditPanel setSidebarOpen={setSidebarOpen} />} />
